  ...
  */
  ...
  Chosen = (function() {
    ...
    Chosen.prototype.choice_build = function(item) {
      ...
      var _this = this;
      // IncomeHawk
      if (this.options.actions_indexes != undefined && $.inArray(item.options_index, this.options.actions_indexes) >= 0) {
        this.result_deselect(item.array_index);
      } else {
    ...
    Chosen.prototype.result_select = function(evt) {
      ...
      if (this.result_highlight) {
        ...
        if (this.options.actions_indexes != undefined && this.options.actions_handlers[item.options_index] != undefined) {
          this.options.actions_handlers[item.options_index].call()
        }
        if (this.is_multiple) {
